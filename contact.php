...
<main>
    <section class="pages">
        <div class="container">
            ...
            <p data-aos="fade-up">
                Мы всегда открыты для новых проектов, обсуждения алгоритмов и профессиональных дискуссий в сфере AI. 
                Свяжитесь с командой <strong><?= $domainTitle ?></strong> любым удобным для вас способом. 
                Наши эксперты в Риме готовы проконсультировать вас по будням с 09:00 до 18:00 (CET).
            </p>

            <div class="contact-cards">
                <div class="contact-card glass" data-aos="zoom-in" data-aos-delay="100">
                    <div class="contact-card__icon">
                        <i data-lucide="mail"></i>
                    </div>
                    <h2>Пишите нам</h2>
                    <p>Для технических вопросов, предложений по блогу и запросов на разработку:</p>
                    <a href="mailto:support@<?= $fullDomain ?>" class="contact-link">support@<?= $fullDomain ?></a>
                </div>

                <div class="contact-card glass" data-aos="zoom-in" data-aos-delay="200">
                    <div class="contact-card__icon">
                        <i data-lucide="phone"></i>
                    </div>
                    <h2>Звоните</h2>
                    <p>Прямая линия для консультаций по внедрению AI-ассистентов:</p>
                    <a href="tel:+390697638399" class="contact-link">+39 06 9763 8399</a>
                </div>

                <div class="contact-card glass" data-aos="zoom-in" data-aos-delay="300">
                    <div class="contact-card__icon">
                        <i data-lucide="map-pin"></i>
                    </div>
                    <h2>Наш офис</h2>
                    <p>Штаб-квартира проекта <?= $domainTitle ?> расположена по адресу:</p>
            ...
            <div class="contact-extra" data-aos="fade-up">
                <p>
                    ...
                    <a href="./#contact" class="back-home">главной странице</a> для мгновенной отправки запроса.
                </p>
            </div>
        </div>
    </section>
